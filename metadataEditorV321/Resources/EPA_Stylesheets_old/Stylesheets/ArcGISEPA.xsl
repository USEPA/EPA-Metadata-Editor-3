...
<!-- An XSLT template for displaying metadata in ArcGIS that is stored in the ArcGIS metadata format.
     ...
     Edited by FRoberts 1/24/2012 - added pointer to EPA xslt
     <res:idTopFGDC />
-->

  <xsl:import href = "ArcGIS_Imports\generalEPA.xslt" />
  <xsl:import href = "ArcGIS_Imports\ItemDescriptionEPA.xslt" />
  ...
  <xsl:import href = "ArcGIS_Imports\codelistsEPA.xslt" />
  ...
  <xsl:variable name="arcgis3" select="/metadata/mdLang/languageCode | /metadata/mdChar/CharSetCd | /metadata/mdHrLv/ScopeCd | /metadata/mdHrLvName | /metadata/mdStanName | /metadata/mdStanVer | /metadata/mdFileID | /metadata/mdDateSt | /metadata/mdContact//* | /metadata/mdParentID | /metadata/dataSetURI | /metadata/mdConst//* | /metadata/mdMaint//* | /metadata/dataIdInfo//* | /metadata/distInfo//* | /metadata/spatRepInfo//* | /metadata/dqInfo//* | /metadata/refSysInfo//* | /metadata/mdExtInfo//* | /metadata/svIdInfo//* | /metadata/contInfo//* | /metadata/porCatInfo//* | /metadata/appSchInfo//* | /metadata/loc//*" />
  ...
  <xsl:if test="$flowdirection = 'RTL'">
	...
	<!--<xsl:if test="$arcgis1[text()] or $arcgis2[text()] or $arcgis3[text()]">
		<h2 class="iso head"><a href="#arcgisMetadata" onclick="hideShow('arcgisMetadata')"><res:idTopArcGIS />&#160;<span id="arcgisMetadataShow" class="show">&#9660;</span><span id="arcgisMetadataHide" class="hide">&#9658;</span></a></h2>
		<xsl:call-template name="arcgis"/> 
	</xsl:if>-->

	<xsl:if test="$fgdc[text()]">
		<h2 class="iso head"><a href="#fgdcMetadata" onclick="hideShow('fgdcMetadata')">FGDC Metadata &#160;<span id="fgdcMetadataShow" class="show">&#9660;</span><span id="fgdcMetadataHide" class="hide">&#9658;</span></a></h2>
