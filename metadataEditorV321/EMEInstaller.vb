...
Public Class EMEInstaller
    ...
    Public Overrides Sub Install(ByVal stateSaver As System.Collections.IDictionary)
        ...
        '\Desktop10.0\Configuration\CATID

        Dim targetDir As String = Utils.getArcgisInstallDir

        If targetDir Is Nothing Then Exit Sub

        IO.File.Copy(Utils.getTemplateFolder + "{f78b4e81-4f41-44b5-9fe7-6389ec1756f5}_epametadataeditor.ecfg", targetDir)
