...
Partial Class SyncManagerForm
    ...
    Private Sub InitializeComponent()
        ...
        Me.clbSynchronizers.Items.AddRange(New Object() {"EPA Synchronizer", "FGDC Synchronizer", "GN Synchronizer", "ISO Synchroizer"})
        ...
        Me.clbSynchronizers.TabIndex = 1
        '
        'Label3
        '
        ...
        Me.Label3.Text = "Note that for EPA compliancy it is recommended that you only select the EPA Synch" & _
    "ronizer"
        '
        'Label1
        '
        ...
        Me.TabPage2.Text = "EPA Sync Settings"
        ...
        Me.cbRetainPublishedDocID.TabIndex = 4
        ...
        Me.cbWipeEsriTagsOnSync.TabIndex = 3
        ...
        Me.Label2.Text = "Select what metadata information to update automatically using the EPA synchroniz" & _
    "er"
        '
        'cbProcSteps
        '
