...
<ComClass(HelpCommand.ClassId, HelpCommand.InterfaceId, HelpCommand.EventsId), _
 ProgId("EPAMetadataEditor.HelpCommand")> _
...
#End Region
    ...
    Public Sub New()
        ...
        MyBase.m_caption = "EME Help"   'localizable text 
        MyBase.m_message = "EME Help"   'localizable text 
        MyBase.m_toolTip = "EME Help" 'localizable text 
        MyBase.m_name = "EPAMetadataEditor_HelpCommand"  'unique id, non-localizable (e.g. "MyCategory_ArcCatalogCommand")
