...
Public Class SyncManagerForm
    ...
    Public Sub New()
        ...
        For i As Integer = 0 To msm.NumSynchronizers - 1
            ...
            If ms.Name = "EPA Synchronizer Helper" Then
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ' Save sync settings
        For i As Integer = 0 To msm.NumSynchronizers - 2
            Dim ms As IMetadataSynchronizer = msm.GetSynchronizer(i)
            If i < idxEpaSynchronizerHelper Then
                msm.SetEnabled(i, Me.clbSynchronizers.GetItemChecked(i))
            Else
                msm.SetEnabled(i, Me.clbSynchronizers.GetItemChecked(i + 1))
            End If
        Next
    ...
    Private Sub clbSynchronizers_ItemCheck(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ItemCheckEventArgs) Handles clbSynchronizers.ItemCheck
        If msm.GetSynchronizer(e.Index).Name = "EPA Synchronizer" AndAlso idxEpaSynchronizerHelper > -1 Then
