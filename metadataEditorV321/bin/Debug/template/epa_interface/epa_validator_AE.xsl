...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:sch="http://www.ascc.net/xml/schematron" xmlns:iso="http://purl.oclc.org/dsdl/schematron" version="1.0">
	...
	<!--RULE -->
	<axsl:template match="/metadata/dataqual/posacc/horizpa/horizpar" priority="4000" mode="M1">
	...
	<!--RULE -->
	<axsl:template match="/metadata" priority="3999" mode="M1">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="dataqual/posacc/horizpa/horizpar"/>

		<!--ASSERT -->
		<axsl:choose>
			<axsl:when test="dataqual/posacc/horizpa/horizpar"/>
			<axsl:otherwise>
	...
	<!--RULE -->
	<axsl:template match="/metadata/dataqual/posacc/horizpav" priority="3998" mode="M1">
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="translate(.,'0123456789.','')=''">
					...
					<svrl:text>Error: 'horizpav' must be a pure number (meters implied), saw '<axsl:text/><axsl:value-of select="//horizpav"/><axsl:text/>' element: Horizontal Position Accuracy Value.</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		<axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M1"/>
	...
	<!--RULE -->
	<axsl:template match="/metadata/distinfo/resdesc" priority="4000" mode="M3">
	...
	<!--RULE -->
	<axsl:template match="/metadata/distinfo/resdesc" priority="3998" mode="M3">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="distinfo/resdesc"/>
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$cv_resdesc[. = current()] or substring-before(.,':')='Geographic Services'">
					<axsl:attribute name="location">/metadata/distinfo/resdesc</axsl:attribute>
					<svrl:text>
						Error: saw '<axsl:text/><axsl:value-of select="."/><axsl:text/>' EPA requires resdesc to match ESRI options:
						'Live Data and Maps', 'Downloadable Data', 'Offline Data', 'Map Files', 'Static Map Images',' Other Documents', 'Applications','Clearinghouses','Geographic Activities' or 'Geographic Services: &lt; Marketplace Record Designation &gt;
					</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
	...
	<!--RULE -->
	<axsl:template match="/metadata" priority="4000" mode="M4">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="distinfo"/>

		<!--ASSERT -->
		<axsl:choose>
			<axsl:when test="distinfo/resdesc"/>
			<axsl:otherwise>
		...
		<!--ASSERT -->
		<axsl:choose>
			<axsl:when test="distinfo/distliab"/>
			<axsl:otherwise>
	...
	<!--RULE -->
	<axsl:template match="/metadata/idinfo/citation/citeinfo/pubinfo/pubplace" priority="4000" mode="M5">
	...
	<!--RULE -->
	<axsl:template match="/metadata/idinfo/citation/citeinfo/pubinfo/publish" priority="3999" mode="M5">
	...
	<!--RULE -->
	<axsl:template match="/" priority="3998" mode="M5">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="citeinfo/pubinfo"/>

		<!--ASSERT -->
		<axsl:choose>
			<axsl:when test="metadata/idinfo/citation/citeinfo/pubinfo/pubplace"/>
			<axsl:otherwise>
		...
		<!--ASSERT -->
		<axsl:choose>
			<axsl:when test="/metadata/idinfo/citation/citeinfo/pubinfo/publish"/>
			<axsl:otherwise>
	...
	<axsl:template match="citeinfo/onlink" priority="3997" mode="M5">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="citeinfo/onlink"/>

		<axsl:choose>
			<axsl:when test="(substring-before(.,'://') = 'http' or   substring-before(.,'://') = 'ftp' or    substring-before(.,'://') = 'file') "/>
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="(substring-before(.,'://') = 'http' or substring-before(.,'://') = 'ftp' or substring-before(.,'://') = 'file')">
					<axsl:attribute name="location">
						<axsl:apply-templates select="." mode="schematron-get-full-path"/>
					</axsl:attribute>
					<svrl:text>
						Error: EPA requires the 'onlink' element to start with 'http://' or 'ftp://' or 'file://' we saw <axsl:text/><axsl:value-of select="."/><axsl:text/>.
					</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
...
-->
	...
	<!--RULE -->
	<axsl:template match="/metadata/idinfo/keywords/theme[themekt='ISO 19115 Topic Category']/themekey" priority="3996" mode="M5">
	...
	<!--RULE -->
	<axsl:template match="/" priority="3995" mode="M5">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="idinfo/keywords"/>

		<!--ASSERT -->
		<axsl:choose>
			<axsl:when test="/metadata/idinfo/keywords/theme[themekt='ISO 19115 Topic Category']"/>
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="theme[themekt='ISO 19115 Topic Category']">
					<axsl:attribute name="location">/metadata/idinfo/keywords/theme[themekt='ISO 19115 Topic Category']/themekt</axsl:attribute>
					<svrl:text>Error: EPA requires an ISO 19115 Topic Category theme thesarus.</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		<axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M5"/>
	...
	<!--RULE -->
	<axsl:template match="/" priority="3994" mode="M5">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="idinfo/keywords/theme[themekt='ISO 19115 Topic Category']"/>

		<!--ASSERT -->
		<axsl:choose>
			<axsl:when test="/metadata/idinfo/keywords/theme[themekt='ISO 19115 Topic Category']/themekey"/>
			<axsl:otherwise>
	...
	<!--RULE -->
	<axsl:template match="/metadata/idinfo/keywords/theme[themekt='ISO 19115 Topic Category']/themekey" priority="3993" mode="M5">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="idinfo/keywords/theme[themekt='ISO 19115 Topic Category']/themekey"/>
	...
	<!--RULE -->
	<axsl:template match="/metadata/idinfo/keywords/theme[themekt='EPA GIS Keyword Thesaurus']/themekey" priority="3992" mode="M5">
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$cv_epa[. = current()]">
					<axsl:attribute name="location">/metadata/idinfo/keywords/theme[themekt='EPA GIS Keyword Thesaurus']/themekt</axsl:attribute>
					<svrl:text>
						Error: saw '<axsl:text/><axsl:value-of select="."/><axsl:text/>' EPA requires EPA Geospatial Keyword Thesaurus keywords to be chosen from
	...
	<!--RULE -->
	<axsl:template match="/" priority="3991" mode="M5">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="idinfo/secinfo"/>

		<!--ASSERT -->
		<axsl:choose>
			<axsl:when test="/metadata/idinfo/secinfo/secsys = 'FIPS Pub 199' "/>
			<axsl:otherwise>
		...
		<!--ASSERT -->
		<axsl:choose>
			<axsl:when test="/metadata/idinfo/secinfo/secclass = 'No Confidentiality' or /metadata/idinfo/secinfo/secclass = 'Medium Confidentiality' or /metadata/idinfo/secinfo/secclass='High Confidentiality' "/>
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="secclass = 'No Confidentiality' or secclass = 'Medium Confidentiality' or secclass='High Confidentiality'">
					<axsl:attribute name="location">/metadata/idinfo/secinfo/secclass</axsl:attribute>
					<svrl:text>
						Error: EPA requires the 'secclass' element to be either 'No Confidentiality', 'Medium Confidentiality' or 'High Confidentiality': saw '<axsl:text/><axsl:value-of select="secclass"/><axsl:text/>'.
					</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
	...
	<!--RULE -->
	<axsl:template match="/" priority="4000" mode="M6">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="idinfo"/>

		<!--ASSERT -->
		<axsl:choose>
			<axsl:when test="/metadata/idinfo/citation/citeinfo/pubinfo"/>
			<axsl:otherwise>
		...
		<!--ASSERT -->
		<axsl:choose>
			<axsl:when test="/metadata/idinfo/secinfo"/>
			<axsl:otherwise>
		...
		<!--ASSERT -->
		<axsl:choose>
			<axsl:when test="/metadata/idinfo/keywords"/>
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//keywords">
					...
					<svrl:text>Error: EPA requires the 'keywords' element: keywords for EPA and Geospatial One-stop use.</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
	...
	<!--RULE -->
	<axsl:template match="/metadata/metainfo/metfrd" priority="4000" mode="M7">
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="string-length(.) &gt; 4 and number($month) &gt; 0 and number($month) &lt; 13">
					<axsl:attribute name="location">/metadata/metainfo/metfrd</axsl:attribute>
					<svrl:text>Error: EPA requires the 'metfrd' element to have month, if present, in the range '1..12', saw a month of '<axsl:text/><axsl:value-of select="$month"/><axsl:text/>' :  Metadata Future Review Date.</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="string-length(.) &gt; 6 and number($day) &gt; 0 and number($day) &lt; 32">
					<axsl:attribute name="location">/metadata/metainfo/metfrd</axsl:attribute>
					<svrl:text>Error: EPA requires the 'metfrd' element to have a day-of-month. if present, in '1..31', saw a day of '<axsl:text/><axsl:value-of select="$day"/><axsl:text/>' :  Metadata Future Review Date.</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
	...
	<axsl:template match="/" priority="4000" mode="M8">
		...
		<!--ASSERT -->
		<axsl:choose>
			<axsl:when test="/metadata/metainfo/metfrd"/>
			<axsl:otherwise>
	...
	<axsl:template match="/" priority="4000" mode="M9">
		...
		<!--ASSERT -->
		<axsl:choose>
			<axsl:when test="/metadata/dataqual"/>
			<axsl:otherwise>
		...
		<!--ASSERT -->
		<axsl:choose>
			<axsl:when test="/metadata/distinfo"/>
			<axsl:otherwise>
	...
	<!--RULE -->
	<axsl:template match="/metadata/spref/horizsys/geodetic/horizdn" priority="4000" mode="M10">
	...
	<!--RULE -->
	<axsl:template match="/metadata/spref/horizsys/geodetic/ellips" priority="3999" mode="M10">
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="normalize-space(.) !=''">
					...
					<svrl:text>Error: EPA requires a non-empty 'ellips' element: .</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		<axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M10"/>
	...
	<!--RULE -->
	<axsl:template match="/metadata/spref/horizsys/geodetic/semiaxis" priority="3998" mode="M10">
	...
	<!--RULE -->
	<axsl:template match="/metadata/spref/horizsys/geodetic/denflat" priority="3997" mode="M10">
	...
	<!--RULE -->
	<axsl:template match="/metadata/spref/horizsys/geodetic" priority="4000" mode="M11">
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="semiaxis">
					<axsl:attribute name="location">/metadata/spref/horizsys/geodetic/semiaxis</axsl:attribute>
					<svrl:text>
						Error: EPA requires the 'semiaxis' element to be a positive number, saw '<axsl:text/><axsl:value-of select="semiaxis"/><axsl:text/>' : Semi-Major Axis.
					</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
	...
	<!--RULE -->
	<axsl:template match="/metadata/spref" priority="4000" mode="M12">
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//geodetic">
					<axsl:attribute name="location">/metadata/spref/geodetic</axsl:attribute>
