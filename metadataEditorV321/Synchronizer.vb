...
<ComClass(Synchronizer.ClassId, Synchronizer.InterfaceId, Synchronizer.EventsId), _
 ProgId("EPAMetadataEditor.Synchronizer")> _
...
#End Region
    ...
    Private Shared Sub slurp(ByVal mdSync As XmlMetadata)
        ...
        Try
            ...
            xslt.Load(Utils.getArcgisMetadataFolder() + "\Translator\Transforms\ArcGIS2FGDC.xsl", xSettings, Nothing)
            ...
            ' and values for XSLT parameters required for an XSLT transformation	    
            ...
            If My.Settings.SyncCSI Then
                ...
                End If
                ' Fix for syncer not outputting plandu for Web Mercator
                If mdSync.SimpleGetProperty("spref/horizsys/planar/mapproj/mapprojn").Contains("Web Mercator") AndAlso mdSync.SimpleGetProperty("spref/horizsys/planar/planci/plandu").Trim = "" Then
                    mdSync.SetPropertyX("spref/horizsys/planar/planci/plandu", "Meters")
                End If
            End If
