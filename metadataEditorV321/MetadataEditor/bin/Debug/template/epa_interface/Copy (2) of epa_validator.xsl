...
<axsl:stylesheet xmlns:axsl="http://www.w3.org/1999/XSL/Transform" xmlns:sch="http://www.ascc.net/xml/schematron" xmlns:iso="http://purl.oclc.org/dsdl/schematron" version="1.0">
	...
	<!--RULE -->
	<axsl:template match="/" priority="3999" mode="M1">
		<svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="dataqual/posacc/horizpa/horizpar"/>
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="translate(.,'0123456789.','')=''">
					...
					<svrl:text>
						Error: 'horizpav' must be a pure number (meters implied), saw '<axsl:text/><axsl:value-of select="//horizpav"/><axsl:text/>' element: Horizontal Position Accuracy Value.
					</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//distliab">
					...
					<svrl:text>Global: EPA requires the 'distliab' element: Distribution liability.</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
...
-->
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="theme[themekt='ISO 19115 Topic Category']">
					...
					<svrl:text>
						Global: EPA requires an ISO 19115 Topic Category theme thesarus, possible typo was '<axsl:text/><axsl:value-of select="theme[1]/themekt[1]"/><axsl:text/>'.
					</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$cv_geo1[. = current()]">
					...
					<svrl:text>
						Global: saw '<axsl:text/><axsl:value-of select="."/><axsl:text/>' EPA requires ISO 19115 Topic Category theme keywords to be chosen from
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="$cv_epa[. = current()]">
					...
					<svrl:text>
						Global: saw '<axsl:text/><axsl:value-of select="."/><axsl:text/>' EPA requires EPA Geospatial Keyword Thesaurus keywords to be chosen from
	...
	<axsl:template match="idinfo/secinfo" priority="3991" mode="M5">
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="secsys = 'FIPS Pub 199'">
					...
					<svrl:text>
						Error: EPA requires the 'secsys' element to be 'FIPS Pub 199': saw '<axsl:text/><axsl:value-of select="secsys"/><axsl:text/>'.
					</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		...
		<!--ASSERT -->
		<axsl:choose>
			<axsl:when test="secclass = 'No Confidentiality' or secclass = 'Medium Confidentiality' or secclass='High Confidentiality' "/>
			<axsl:otherwise>
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//pubinfo">
					...
					<svrl:text>Global: EPA requires the 'pubinfo' element: Publication information.</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//keywords">
					...
					<svrl:text>Global: EPA requires the 'keywords' element: keywords for EPA and Geo One-stop use.</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="number($year) &gt; 2006">
					...
					<svrl:text>
						Error: EPA requires the 'metfrd' element to be in after this checker was introduced, saw '<axsl:text/><axsl:value-of select="$year"/><axsl:text/>' which should be greater than 2006: Metadata Future Review Date.
					</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="translate(.,'0123456789','')='' and ( string-length(.) = 8 or string-length(.) = 6 or string-length(.) = 4)">
					...
					<svrl:text>
						Error: EPA requires the 'metfrd' element to be of the form 'yyyymmdd' or 'yyyymm' or 'yyyy', saw <axsl:text/><axsl:value-of select="."/><axsl:text/> :  Metadata Future Review Date.
					</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//metfrd">
					...
					<svrl:text>Global: EPA requires the 'metfrd' element: metadata future review date.</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
	...
	<!--RULE -->
	<axsl:template match="/metadata" priority="4000" mode="M9">
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//dataqual">
					...
					<svrl:text>Global: EPA requires the 'dataqual' element: a general assessment of the quality of the data set.</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//spref">
					...
					<svrl:text>Global: EPA requires the 'spref' element: descriptions of the reference frame for, and the means to encode, coordinates in the data set.</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//distinfo">
					...
					<svrl:text>Global: EPA requires the 'distinfo' element: information about the distributor of and options for obtaining the data set.</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="translate(.,'0123456789.','')='' and number(.) &gt; number('0.0')">
					...
					<svrl:text>
						Error: EPA requires the 'semiaxis' element to be a positive number, saw '<axsl:text/><axsl:value-of select="."/><axsl:text/>' : Semi-Major Axis.
					</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="translate(.,'0123456789.','')='' and number(.) &gt; 0.0">
					...
					<svrl:text>
						Error: EPA requires the 'denflat' element to be a positive number, saw '<axsl:text/><axsl:value-of select="."/><axsl:text/>' : Denominator of Flattening Ratio.
					</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="denflat and translate(denflat,'0123456789.','')='' and number(denflat) &gt; 0.0">
					...
					<svrl:text>
						Error: EPA requires the 'denflat' element to be a positive number, saw '<axsl:text/><axsl:value-of select="denflat"/><axsl:text/>' : Denominator of Flattening Ratio.
					</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//horizsys">
					...
					<svrl:text>Global: EPA requires the 'horizsys' element: horizontal coordinate system information.</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
		...
		<axsl:choose>
			...
			<axsl:otherwise>
				<svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="//geodetic">
					...
					<svrl:text>Global: EPA requires the 'geodetic' element: geodetic model.</svrl:text>
				</svrl:failed-assert>
			</axsl:otherwise>
		</axsl:choose>
