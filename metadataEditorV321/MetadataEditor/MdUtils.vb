...
Module MdUtils
    ...
    Function getRepeatCount(parentTag As String, leafTag As String) As Integer
        Dim props As Object = iXPS.GetProperty(parentTag)
        If props Is Nothing Then Return 0

        Dim cnt As Integer = 0
        For Each prop As String In props
            If prop = leafTag Then cnt += 1
        Next
        Return cnt
    End Function
    ...
    ''' <remarks></remarks>
    Function injectIndex(xpath As String, idx As Integer) As String
        Return xpath.Replace("?", Str(idx).Trim)
    End Function
